  ...
  <header class = "header">
    <div class = "header-content container">
      <div class="header-txt">
          ...
          <h3 class="fw-normal text-white mb-4">Construye lo que quieras con Meraki: Tu socio en impresiones gráficas.</h3>
          <div class="botones">
              <div class="d-flex gap-2 justify-content-center lead fw-normal">
                  <a class="icon-link" href="Conocemas.php">
                      Conoce más de nosotros
                      <svg class="bi"><use xlink:href="#chevron-right"/></svg>
                  </a>
                  <a class="icon-link" href="MisionVision.php">
                      Mision y Vision
                      <svg class="bi"><use xlink:href="#chevron-right"/></svg>
                  </a>
              </div>
      ...
      <div class="header-img">
         <img src="../../images/logo meraky impresionesconoce.png" class="hamburger" alt="">
      </div>
    </div>
  </header>
